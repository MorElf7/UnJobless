...
const FileUploadForm: React.FC<Props> = ({ nextStep, prevStep, setFileData, formData }) => {
  ...
  return (
    <div className="max-w-md mx-auto space-y-4">
      <div>
        <label htmlFor="resumeInput" className="block text-sm font-medium text-gray-700">
          Resume (PDF):
        </label>
        <input
          id="resumeInput"
      ...
      <div>
        <label htmlFor="coverLetterInput" className="block text-sm font-medium text-gray-700">
          Cover Letter (PDF):
        </label>
        <input
          id="coverLetterInput"
      ...
      <div className="flex justify-between">
        <button onClick={goBack} className="py-2 px-4 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">
          Back
        </button>
        <button onClick={continueNext} className="py-2 px-4 bg-green-500 text-white rounded-md hover:bg-green-600">
          Next
        </button>
      </div>
    </div>
