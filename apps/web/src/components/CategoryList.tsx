...
function CategoryList() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto gap-5 py-5">
            ...
            <a href="#" className="card-item flex items-center bg-yellow-100 border-2 border-yellow-400 p-6 rounded-lg shadow-sm hover:bg-yellow-400 transition duration-400 ease-in-out">
                <div className="content min-w-24">
                    <div className="text-3xl font-semibold text-gray-800 mb-2">300</div>
            ...
            <a href="#" className="card-item flex items-center bg-red-100 border-2 border-red-400 p-6 rounded-lg shadow-sm hover:bg-red-400 transition duration-400 ease-in-out">
                <div className="content min-w-24">
                    <div className="text-3xl font-semibold text-gray-800 mb-2">300</div>
